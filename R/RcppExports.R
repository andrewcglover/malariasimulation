...
create_adult_mosquito_model <- function(growth_model, mu, deltaq, spor_len, dem, kappa, foim) {
    .Call(`_malariasimulation_create_adult_mosquito_model`, growth_model, mu, deltaq, spor_len, dem, kappa, foim)
}

adult_mosquito_model_update <- function(model, mu, foim, av_da, delta_atn, dn_atn, Lambda0_t, Lambda_i, rho_i, B_post, f) {
    invisible(.Call(`_malariasimulation_adult_mosquito_model_update`, model, mu, foim, av_da, delta_atn, dn_atn, Lambda0_t, Lambda_i, rho_i, B_post, f))
}
