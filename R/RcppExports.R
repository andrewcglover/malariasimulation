...
create_adult_mosquito_model <- function(growth_model, mu, deltaq, spor_len, dem, foim) {
    .Call(`_malariasimulation_create_adult_mosquito_model`, growth_model, mu, deltaq, spor_len, dem, foim)
}
